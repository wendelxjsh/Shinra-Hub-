		...
		function S154_:AddSection(S164_arg0, S165_arg1)
			...
			function S184_:AddSlider(S229_arg0)
				...
				S239_.InputBegan:Connect(function(S254_arg0)
					if S254_arg0.UserInputType == Enum.UserInputType.MouseButton1 or S254_arg0.UserInputType == Enum.UserInputType.Touch then 
						S248_ = true 
				...
				S239_.InputEnded:Connect(function(S255_arg0) 
					if S255_arg0.UserInputType == Enum.UserInputType.MouseButton1 or S255_arg0.UserInputType == Enum.UserInputType.Touch then 
						S248_ = false 
				...
				S1_.InputChanged:Connect(function(S256_arg0)
					if S248_ and (S256_arg0.UserInputType == Enum.UserInputType.MouseMovement or S256_arg0.UserInputType == Enum.UserInputType.Touch) then 
						updateSliderFromInput()
					end
				end)
			...
			function S184_:AddKeybind(S310_arg0)
				...
				S311_.Title = S311_.Title or "Keybind"
				S311_.Content = S311_.Content or "Press to set keybind"
