...
local function S6_func()
	...
	S11_.CornerRadius = UDim.new(0, 99)
	S11_.Parent = S13_
...
function S9_:MakeGui(S91_arg0)
	...
	function S137_:CreateTab(S143_arg0)
		...
		local S152_ = Instance.new("UICorner");
		...
		if S138_ == 0 then
			...
			S156_.Size = UDim2.new(0, 3, 0, 12)  -- Aumentado de 1 para 3
		...
		S149_.Activated:Connect(function()
			...
			if S157_ ~= nil and S147_.LayoutOrder ~= S120_.CurrentPage.LayoutOrder then
				...
				S2_:Create(
					...
					Size = UDim2.new(0, 3, 0, 20)  -- Aumentado de 1 para 3
				}):Play()
				task.wait(0.2)
				S2_:Create(
					S157_, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
					Size = UDim2.new(0, 3, 0, 12)  -- Aumentado de 1 para 3
				}):Play()
			end
		end)
		--// Section 
		...
		function S154_:AddSection(S164_arg0, S165_arg1)
			...
			local function applyThemeToSection(theme)
				local themeData = themes[theme] or themes["Dark"]
				S172_.BackgroundColor3 = themeData.Secondary
				S178_.TextColor3 = themeData.Text
			end
			...
			function S184_:AddSlider(S229_arg0)
				...
				S239_.Size = UDim2.new(0, 100, 0, 8)  -- Aumentado de 3 para 8 para mobile
				...
				S241_.Size = UDim2.new(0.899999976, 0, 0, 6)  -- Aumentado de 1 para 6
				...
				S244_.Size = UDim2.new(0, 12, 0, 12)  -- Aumentado de 8 para 12
				...
				local function updateSliderFromInput()
					local inputPos
					if S1_.TouchEnabled and S248_ then
						inputPos = S1_:GetMouseLocation().X
					else
						inputPos = S3_:GetMouse().X
					end
					
					local relativeX = (inputPos - S239_.AbsolutePosition.X) / S239_.AbsoluteSize.X
					relativeX = math.clamp(relativeX, 0, 1)
					S231_:Set(S230_.Min + ((S230_.Max - S230_.Min) * relativeX))
				end
				...
				-- Slider para PC e Mobile
				local function onSliderInput(inputObject)
					if inputObject.UserInputType == Enum.UserInputType.MouseButton1 or inputObject.UserInputType == Enum.UserInputType.Touch then
						S248_ = true
						updateSliderFromInput()
						
						-- Conexão para movimento contínuo
						local moveConnection
						moveConnection = S1_.InputChanged:Connect(function(moveInput)
							if S248_ and (moveInput.UserInputType == Enum.UserInputType.MouseMovement or moveInput.UserInputType == Enum.UserInputType.Touch) then
								updateSliderFromInput()
							end
						end)
						...
						releaseConnection = S1_.InputEnded:Connect(function(releaseInput)
				...
				S239_.InputBegan:Connect(onSliderInput)
				S241_.InputBegan:Connect(onSliderInput)
				S244_.InputBegan:Connect(onSliderInput)
			...
			function S184_:AddDropdown(S271_arg0)
				...
				function S273_:Set(S288_arg0)
					...
					for S290_forvar0, S291_forvar1 in S283_:GetChildren() do
						if S291_forvar1.Name ~= "UIListLayout" then
							if table.find(S273_.Value, S291_forvar1.OptionText.Text) then
								S2_:Create(
			...
			function S184_:AddKeybind(S310_arg0)
				local S311_ = S310_arg0 or {}
				S311_.Title = S311_.Title or "UI Toggle Keybind"
				S311_.Content = S311_.Content or "Key to open/close UI"
				S311_.Default = S311_.Default or Enum.KeyCode.RightControl
				S311_.Callback = S311_.Callback or function() end
				...
				local S313_ = Instance.new("Frame")
				local S314_ = Instance.new("UICorner")
				local S315_ = Instance.new("TextLabel")
				local S316_ = Instance.new("TextLabel")
				local S317_ = Instance.new("TextButton")
				local S318_ = Instance.new("Frame")
				local S319_ = Instance.new("UICorner")
				local S320_ = Instance.new("TextLabel")

				S313_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S313_.BackgroundTransparency = 0.9350000023841858
				S313_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S313_.BorderSizePixel = 0
				S313_.LayoutOrder = S185_
				S313_.Size = UDim2.new(1, 0, 0, 46)
				S313_.Name = "Keybind"
				S313_.Parent = S179_

				S314_.CornerRadius = UDim.new(0, 4)
				S314_.Parent = S313_

				S315_.Font = Enum.Font.GothamBold
				S315_.Text = S311_.Title
				S315_.TextColor3 = Color3.fromRGB(230.77499270439148, 230.77499270439148, 230.77499270439148)
				S315_.TextSize = 13
				S315_.TextXAlignment = Enum.TextXAlignment.Left
				S315_.TextYAlignment = Enum.TextYAlignment.Top
				S315_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S315_.BackgroundTransparency = 0.9990000128746033
				S315_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S315_.BorderSizePixel = 0
				S315_.Position = UDim2.new(0, 10, 0, 10)
				S315_.Size = UDim2.new(1, -180, 0, 13)
				S315_.Name = "KeybindTitle"
				S315_.Parent = S313_

				S316_.Font = Enum.Font.GothamBold
				S316_.Text = S311_.Content
				S316_.TextColor3 = Color3.fromRGB(255, 255, 255)
				S316_.TextSize = 12
				S316_.TextTransparency = 0.6000000238418579
				S316_.TextXAlignment = Enum.TextXAlignment.Left
				S316_.TextYAlignment = Enum.TextYAlignment.Bottom
				S316_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S316_.BackgroundTransparency = 0.9990000128746033
				S316_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S316_.BorderSizePixel = 0
				S316_.Position = UDim2.new(0, 10, 0, 23)
				S316_.Size = UDim2.new(1, -180, 0, 12)
				S316_.Name = "KeybindContent"
				S316_.Parent = S313_

				S317_.Font = Enum.Font.SourceSans
				S317_.Text = ""
				S317_.TextColor3 = Color3.fromRGB(0, 0, 0)
				S317_.TextSize = 14
				S317_.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
				S317_.BackgroundTransparency = 0.9990000128746033
				S317_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S317_.BorderSizePixel = 0
				S317_.Size = UDim2.new(1, 0, 1, 0)
				S317_.Name = "KeybindButton"
				S317_.Parent = S313_

				S318_.AnchorPoint = Vector2.new(1, 0.5)
				S318_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S318_.BackgroundTransparency = 0.949999988079071
				S318_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S318_.BorderSizePixel = 0
				S318_.Position = UDim2.new(1, -7, 0.5, 0)
				S318_.Size = UDim2.new(0, 148, 0, 30)
				S318_.Name = "KeybindFrame"
				S318_.Parent = S313_

				S319_.CornerRadius = UDim.new(0, 4)
				S319_.Parent = S318_

				S320_.Font = Enum.Font.GothamBold
				S320_.Text = "RightControl"
				S320_.TextColor3 = Color3.fromRGB(255, 255, 255)
				S320_.TextSize = 12
				S320_.TextXAlignment = Enum.TextXAlignment.Center
				S320_.AnchorPoint = Vector2.new(0.5, 0.5)
				S320_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S320_.BackgroundTransparency = 0.9990000128746033
				S320_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S320_.BorderSizePixel = 0
				S320_.Position = UDim2.new(0.5, 0, 0.5, 0)
				S320_.Size = UDim2.new(1, -10, 1, -8)
				S320_.Name = "KeybindText"
				S320_.Parent = S318_

				local function updateKeybindDisplay()
					S320_.Text = tostring(S312_.Value):gsub("Enum.KeyCode.", "")
				end

				local function startListening()
					S312_.Listening = true
					S320_.Text = "[PRESS KEY]"
					S320_.TextColor3 = S92_.Color
					
					local connection
					connection = S1_.InputBegan:Connect(function(input, gameProcessed)
						if gameProcessed or input.UserInputType ~= Enum.UserInputType.Keyboard then 
							return 
						end
						
						S312_.Value = input.KeyCode
						S312_.Listening = false
						currentKeybind = input.KeyCode
						updateKeybindDisplay()
						S320_.TextColor3 = Color3.fromRGB(255, 255, 255)
						setupKeybind()
						S311_.Callback(input.KeyCode)
						connection:Disconnect()
						
						-- Notificação
						SpeedHubX:MakeNotify({
							Title = "Keybind Updated",
							Description = "Success",
							Content = "UI toggle keybind set to: " .. tostring(input.KeyCode):gsub("Enum.KeyCode.", ""),
							Color = Color3.fromRGB(255, 255, 0)
						})
					end)
				end

				S317_.Activated:Connect(function()
					if not S312_.Listening then
						startListening()
					end
				end)

				function S312_:Set(S321_arg0)
					S312_.Value = S321_arg0 or S312_.Value
					currentKeybind = S312_.Value
					updateKeybindDisplay()
					setupKeybind()
				end

				S312_:Set(S311_.Default)
				S185_ = S185_ + 1
				return S312_
			end
			
			function S184_:AddThemeSelector()
				local themeSelector = {}
				
				local S322_ = Instance.new("Frame")
				local S323_ = Instance.new("UICorner")
				local S324_ = Instance.new("TextLabel")
				local S325_ = Instance.new("TextLabel")
				local S326_ = Instance.new("TextButton")
				local S327_ = Instance.new("Frame")
				local S328_ = Instance.new("UICorner")
				local S329_ = Instance.new("TextLabel")

				S322_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S322_.BackgroundTransparency = 0.9350000023841858
				S322_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S322_.BorderSizePixel = 0
				S322_.LayoutOrder = S185_
				S322_.Size = UDim2.new(1, 0, 0, 46)
				S322_.Name = "ThemeSelector"
				S322_.Parent = S179_

				S323_.CornerRadius = UDim.new(0, 4)
				S323_.Parent = S322_

				S324_.Font = Enum.Font.GothamBold
				S324_.Text = "Theme"
				S324_.TextColor3 = Color3.fromRGB(230.77499270439148, 230.77499270439148, 230.77499270439148)
				S324_.TextSize = 13
				S324_.TextXAlignment = Enum.TextXAlignment.Left
				S324_.TextYAlignment = Enum.TextYAlignment.Top
				S324_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S324_.BackgroundTransparency = 0.9990000128746033
				S324_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S324_.BorderSizePixel = 0
				S324_.Position = UDim2.new(0, 10, 0, 10)
				S324_.Size = UDim2.new(1, -180, 0, 13)
				S324_.Name = "ThemeTitle"
				S324_.Parent = S322_

				S325_.Font = Enum.Font.GothamBold
				S325_.Text = "Select interface theme"
				S325_.TextColor3 = Color3.fromRGB(255, 255, 255)
				S325_.TextSize = 12
				S325_.TextTransparency = 0.6000000238418579
				S325_.TextXAlignment = Enum.TextXAlignment.Left
				S325_.TextYAlignment = Enum.TextYAlignment.Bottom
				S325_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S325_.BackgroundTransparency = 0.9990000128746033
				S325_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S325_.BorderSizePixel = 0
				S325_.Position = UDim2.new(0, 10, 0, 23)
				S325_.Size = UDim2.new(1, -180, 0, 12)
				S325_.Name = "ThemeContent"
				S325_.Parent = S322_

				S326_.Font = Enum.Font.SourceSans
				S326_.Text = ""
				S326_.TextColor3 = Color3.fromRGB(0, 0, 0)
				S326_.TextSize = 14
				S326_.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
				S326_.BackgroundTransparency = 0.9990000128746033
				S326_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S326_.BorderSizePixel = 0
				S326_.Size = UDim2.new(1, 0, 1, 0)
				S326_.Name = "ThemeButton"
				S326_.Parent = S322_

				S327_.AnchorPoint = Vector2.new(1, 0.5)
				S327_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S327_.BackgroundTransparency = 0.949999988079071
				S327_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S327_.BorderSizePixel = 0
				S327_.Position = UDim2.new(1, -7, 0.5, 0)
				S327_.Size = UDim2.new(0, 148, 0, 30)
				S327_.Name = "ThemeFrame"
				S327_.Parent = S322_

				S328_.CornerRadius = UDim.new(0, 4)
				S328_.Parent = S327_

				S329_.Font = Enum.Font.GothamBold
				S329_.Text = "Dark"
				S329_.TextColor3 = Color3.fromRGB(255, 255, 255)
				S329_.TextSize = 12
				S329_.TextXAlignment = Enum.TextXAlignment.Center
				S329_.AnchorPoint = Vector2.new(0.5, 0.5)
				S329_.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				S329_.BackgroundTransparency = 0.9990000128746033
				S329_.BorderColor3 = Color3.fromRGB(0, 0, 0)
				S329_.BorderSizePixel = 0
				S329_.Position = UDim2.new(0.5, 0, 0.5, 0)
				S329_.Size = UDim2.new(1, -10, 1, -8)
				S329_.Name = "ThemeText"
				S329_.Parent = S327_

				local themeOptions = {"Dark", "Light", "Blue", "Green"}
				local currentThemeIndex = 1

				local function updateThemeDisplay()
					S329_.Text = themeOptions[currentThemeIndex]
				end
				...
				local function applyTheme(themeName)
					...
					if themeData then
						-- Aplicar tema aos elementos principais
						S97_.BackgroundColor3 = themeData.Background
						S101_.TextColor3 = themeData.Text
						S103_.TextColor3 = themeData.Accent
						S117_.TextColor3 = themeData.Text
						
						-- Atualizar cor principal da GUI
						S92_.Color = themeData.Accent
					end
				end

				S326_.Activated:Connect(function()
					currentThemeIndex = currentThemeIndex + 1
					if currentThemeIndex > #themeOptions then
						currentThemeIndex = 1
					end
					
					local newTheme = themeOptions[currentThemeIndex]
					updateThemeDisplay()
					applyTheme(newTheme)
				end)
